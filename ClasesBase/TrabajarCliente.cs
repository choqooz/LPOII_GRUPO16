...
namespace ClasesBase
{
    public class TrabajarClientes
    {
        ...
        {
            SqlConnection cn = new SqlConnection(ClasesBase.Properties.Settings.Default.vehiculosConnectionString);
        ...
        public static void InsertarCliente(Cliente cliente)
        {
            try
            {
                using (SqlConnection cnn = new SqlConnection(ClasesBase.Properties.Settings.Default.vehiculosConnectionString))
                {
                    cnn.Open();
